...
/* harmony import */ var _Hunter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Hunter */ "./js/Hunter.js");
/* harmony import */ var _Counter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Counter */ "./js/Counter.js");
...
function () {
  ...
  _createClass(Game, [{
    ...
    value: function createHunter() {
      this.hunter = new _Hunter__WEBPACK_IMPORTED_MODULE_1__["default"]();
      this.entities = [].concat(_toConsumableArray(this.entities), [this.hunter]);
    }
  }, {
    key: "createCounter",
    value: function createCounter() {
      this.counter = new _Counter__WEBPACK_IMPORTED_MODULE_2__["default"]();
    }
  }, {
    key: "addBird",
